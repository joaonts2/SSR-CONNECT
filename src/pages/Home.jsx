...
import { Search, ArrowRight, BookOpen, CalendarDays, Newspaper, Image as ImageIcon, Users, FlaskConical, Calculator, GraduationCap, Megaphone, AlertTriangle, ChevronRight } from "lucide-react";
...
const news = [
  { tag: "Evento", date: "10 Ago 2026", title: "Feira de Ciências Prism 2026 abre inscrições", excerpt: "Alunos do Fundamental II e Médio já podem inscrever seus projetos até 20 de agosto." },
  { tag: "Acadêmico", date: "05 Ago 2026", title: "Resultados do Simulado ENEM foram publicados", excerpt: "Confira o desempenho geral e individual dos alunos no portal do aluno." },
  { tag: "Comunidade", date: "01 Ago 2026", title: "Programa de Intercâmbio Cultural recebe novos parceiros", excerpt: "Três novas instituições internacionais firmam parceria com a Prism." },
];
...
const events = [
  { day: "12", month: "Ago", title: "Reunião de Pais — Ensino Médio", time: "19h00 · Auditório" },
  { day: "20", month: "Ago", title: "Inscrições Feira de Ciências", time: "Encerramento" },
  { day: "24", month: "Ago", title: "Simulado Vestibular", time: "08h00 · Salas 201-210" },
  { day: "07", month: "Set", title: "Semana da Independência", time: "Programação especial" },
];
...
export default function Home() {
  ...
  return (
    <div>
      {/* PULSE BAR — status em tempo real */}
      ...
      <section className="relative flex min-h-[88vh] items-center justify-center overflow-hidden px-4">
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          <motion.span
            ...
            className="inline-block rounded-full glass-ui px-5 py-2 text-xs font-semibold uppercase tracking-widest text-primary"
          >
          ...
          <motion.h1
            ...
            className="heading-font mt-6 text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl text-balance"
          >
            Onde o Conhecimento <br className="hidden sm:block" />
            Encontra o <span className="bg-gradient-to-r from-secondary to-primary bg-clip-text text-transparent italic">Futuro.</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg text-balance"
          >
            Um ecossistema educacional completo, projetado para moldar mentes críticas e líderes
            globais através da tecnologia, inovação e acessibilidade para toda a comunidade escolar.
          </motion.p>
          ...
          >
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-full glass-ui py-4 pl-12 pr-4 text-sm text-foreground outline-none ring-primary transition focus:ring-2"
              />
            </div>
            <button
              type="submit"
              className="inline-flex items-center justify-center gap-2 rounded-full bg-secondary px-8 py-4 text-sm font-semibold text-white shadow-lg shadow-secondary/30 transition hover:scale-105"
            >
          ...
          <motion.div
            ...
            className="mt-8 flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm text-muted-foreground"
          >
      ...
      {/* KNOWLEDGE HUB — módulos em tiles */}
      <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <SectionHeading
          eyebrow="Hub do Conhecimento"
          title="Tudo o que você precisa, em um só lugar"
          description="Centralize o acesso às ferramentas e informações essenciais da vida escolar — para alunos, professores, pais e comunidade."
        />
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {hubTiles.map((t, i) => (
            ...
            >
              <Link
                to={t.to}
                className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-border bg-card p-8 transition-all duration-500 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-primary/10"
              >
                <span className={`flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${t.color} text-white shadow-lg`}>
      ...
      <section className="relative overflow-hidden border-y border-border bg-card/30 py-24">
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          ...
          <div>
            <SectionHeading
              align="left"
              eyebrow="Sobre a Prism"
              title="Uma instituição construída sobre o futuro"
              description="Há mais de duas décadas, a Escola Prism une tradição acadêmica e inovação tecnológica para oferecer uma educação transformadora."
            />
            <p className="mt-5 text-sm leading-relaxed text-muted-foreground">
              Nossa metodologia integra tecnologias emergentes, aprendizado projetivo e um
              acompanhamento individualizado, preparando cada estudante para os desafios de um
            ...
            <Link to="/sobre" className="mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition hover:scale-105">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {courses.map((c, i) => (
            <motion.div
              ...
              whileInView="show"
              viewport={{ once: true, margin: "-60px" }}
              className="group rounded-3xl border border-border bg-card p-8 transition hover:border-primary/40 hover:shadow-xl"
            >
              ...
              <Link to="/cursos" className="mt-5 inline-flex items-center gap-1 text-sm font-semibold text-primary">
                Saiba mais <ChevronRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
              </Link>
            </motion.div>
          ))}
        </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-3 lg:px-8">
          <div className="lg:col-span-2">
            <div className="flex items-end justify-between">
              ...
              <Link to="/noticias" className="hidden text-sm font-semibold text-primary hover:underline sm:inline-flex">
                Ver todas
              </Link>
            </div>
            <div className="mt-8 space-y-5">
              {news.map((n, i) => (
                <motion.article
                  ...
                  whileInView="show"
                  viewport={{ once: true }}
                  className="group flex gap-5 rounded-2xl border border-border bg-background p-5 transition hover:border-primary/40 hover:shadow-lg"
                >
                  <div className="flex h-24 w-32 shrink-0 flex-col items-center justify-center rounded-xl bg-gradient-to-br from-primary/15 to-secondary/15">
                    <span className="text-xs font-medium text-muted-foreground">{n.date.split(" ")[1]}</span>
                    <span className="heading-font text-3xl font-bold text-primary">{n.date.split(" ")[0]}</span>
                  </div>
                  <div>
          ...
          <div>
            ...
            <div className="mt-8 space-y-4">
              {notices.map((n, i) => (
                ...
                >
                  <span className={`mt-0.5 ${n.type === "Urgente" ? "text-amber-500" : "text-primary"}`}>
                    {n.type === "Urgente" ? <AlertTriangle className="h-5 w-5" /> : <Megaphone className="h-5 w-5" />}
                  </span>
                  <div>
                    <span className={`text-[11px] font-semibold uppercase tracking-wide ${n.type === "Urgente" ? "text-amber-600 dark:text-amber-400" : "text-primary"}`}>
                      {n.type}
                    </span>
      ...
      <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between">
          ...
          <Link to="/calendario" className="hidden text-sm font-semibold text-primary hover:underline sm:inline-flex">
            Calendário completo
          </Link>
        </div>
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {events.map((e, i) => (
            <motion.div
              ...
              whileInView="show"
              viewport={{ once: true }}
              className="group flex items-center gap-4 rounded-2xl border border-border bg-card p-5 transition hover:-translate-y-1 hover:border-primary/40 hover:shadow-lg"
            >
              <div className="flex h-16 w-16 shrink-0 flex-col items-center justify-center rounded-xl bg-gradient-to-br from-primary to-secondary text-white">
                <span className="heading-font text-2xl font-bold leading-none">{e.day}</span>
                <span className="text-[11px] uppercase">{e.month}</span>
              </div>
              <div>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-blue-600 to-secondary px-8 py-16 text-center text-white shadow-2xl sm:px-16">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-4 max-w-xl text-white/90 text-balance">
              Matrículas abertas para 2027. Agende uma visita ou fale com nossa secretaria.
            </p>
            <Link to="/contato" className="mt-8 inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 text-sm font-semibold text-primary shadow-lg transition hover:scale-105">
              Iniciar matrícula <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
      </section>
